...
describe('Diagram tests (without workflow_id)', () => {
  ...
  test('getDiagramsByUserId', async () => {
    const fetched_diagrams = await Diagram.fetchByUserId('60d89f41-40ef-40c2-82f4-373083bd65d2');
    expect(fetched_diagrams.length).toBeTruthy();
    expect(fetched_diagrams[0].user_id).toEqual('60d89f41-40ef-40c2-82f4-373083bd65d2');
  });
...
describe('Diagram tests (with workflow_id)', () => {
  ...
  test('getDiagramsByWorkflowId', async () => {
    const fetched_diagrams = await Diagram.fetchByWorkflowId('ae7e95f6-787a-4c0b-8e1a-4cc122e7d68f', '60d89f41-40ef-40c2-82f4-373083bd65d2');
    expect(fetched_diagrams.length).toBeTruthy();
  ...
  test('getLatestDiagramByWorkflowId', async () => {
    const fetched_diagram = await Diagram.fetchLatestByWorkflowId('ae7e95f6-787a-4c0b-8e1a-4cc122e7d68f', '60d89f41-40ef-40c2-82f4-373083bd65d2');
  ...
  test('getDiagramsByUserAndWF', async () => {
    const fetched_diagrams = await Diagram.fetchByUserAndWF('60d89f41-40ef-40c2-82f4-373083bd65d2', 'ae7e95f6-787a-4c0b-8e1a-4cc122e7d68f');
    expect(fetched_diagrams.length).toBeTruthy();
    expect(fetched_diagrams[0].workflow_id).toEqual('ae7e95f6-787a-4c0b-8e1a-4cc122e7d68f');
    expect(fetched_diagrams[0].user_id).toEqual('60d89f41-40ef-40c2-82f4-373083bd65d2');
  });
