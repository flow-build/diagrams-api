...
describe('Blueprint tests', () => {
  ...
  test('save blueprint', async () => {
    const blueprintInstance = new Blueprint(blueprint);
    ...
    expect(saved_blueprint.blueprint_spec).toEqual(blueprint);
  });
  ...
  test('get blueprint by id', async () => {
    ...
    expect(fetched_blueprint.blueprint_spec).toEqual(blueprint);
  });
});